...
\setcounter{chapter}{8} %Makes the prereq chapter chapter 0
...
\section{ChatGPT}
    ...
    Finally, we will see how to use gradient-descent methods to train the weights of an RNN so that it performs a transduction that matches as closely as possible a training set of input-output sequences. This method is called \vocab{backpropagation through time} (BPTT).
