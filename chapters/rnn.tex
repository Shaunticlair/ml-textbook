        ...
        \begin{itemize}
            ...
            \item \vocab{Ch.10: Recurrent Neural Networks (RNNs)}
                ...
                \begin{itemize}
                    ...
                    \item Our RNN makes predictions based the present (input $x_t$) \purp{combined with} the past (state $s_{t-1}$).
                \end{itemize}
            ...
            \item \redd{Ch.12: Markov Decision Process}
                \begin{itemize}
                    ...
                    \item With MDPs, our model represents different possible \purp{decisions} it can make over time, with different possible \textbf{rewards}.
                \end{itemize}
