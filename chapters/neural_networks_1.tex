...
\section{Basic Element}
    ...
    \subsection{Putting it together}
        ...
        \begin{definition}
            Our \vocab{neuron} has several important intermediate outputs:
            ...
            \begin{itemize}
                ...
                \item The \vocab{activation} $\pur{a}$ is the \purp{output} of the \purp{activation function}.

                \begin{itemize}
                    \item It is also the \purp{output} of the \purp{neuron}.
                \end{itemize}
